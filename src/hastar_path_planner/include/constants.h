...
static const bool twoD = false; // You are supposed to keep this false
...
static const double bloating = 0.55;
/// [m] --- The width of the vehicle
static const double width = 1.1+ 2 * bloating;
/// [m] --- The length of the vehicle
static const double length = 2.52 + 2 * bloating;
...
static const float wheel_base = 2.52;
static const float wheel_width = 1.1;
static const float steering_limit = M_PI/180*75;
// FL, FR, RL, RR
static const float half_l = wheel_base/2;
static const float half_w = wheel_width/2;
static const bool has_steer_limit = true;
// N psi should be >90 if rear_steer_limit is small
...
// static const float control_center_offset = 0.;
static const std::vector<float> wheel_positions_x=
  {half_l, 
  half_l, 
  control_center_offset, 
  control_center_offset};
...
// static const float rear_steer_limit = 2e-4;
